...
{
    /// <summary>
    /// Represents a "voting starts" event from the Ahjo system, containing the voting number, type, and aye/nay texts and titles in Finnish and Swedish.
    /// </summary>
    public class VotingStartsRoomEventDTO : EventDTO
    {
        [JsonProperty("numero")]
